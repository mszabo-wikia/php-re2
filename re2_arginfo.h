...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_RE2_Pattern_quote, 0, 1,
                                        IS_STRING, 0)
ZEND_ARG_TYPE_INFO(0, text, IS_STRING, 0)
ZEND_END_ARG_INFO()
    ...
    ZEND_ME(RE2_Pattern, __construct, arginfo_class_RE2_Pattern___construct,
        ...
        ZEND_ME(RE2_Pattern, matches, arginfo_class_RE2_Pattern_matches,
            ...
            ZEND_ME(RE2_Pattern, captures, arginfo_class_RE2_Pattern_captures,
                    ZEND_ACC_PUBLIC)
                ZEND_ME(RE2_Pattern, quote, arginfo_class_RE2_Pattern_quote,
                        ZEND_ACC_PUBLIC | ZEND_ACC_STATIC) ZEND_FE_END};
